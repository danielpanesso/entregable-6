...
test("POST -> 'BASE_URL/login', sould return statusCode 200, and res.body.email ===user.email and res.body.token to be defined ", async () => {
...
test("POST 'BASE_URL/login , sould return statusCode 401",
async () => {
const userInvalid = {
  email: "maicol@gmail.com",
